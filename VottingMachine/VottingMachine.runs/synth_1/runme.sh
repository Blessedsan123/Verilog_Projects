...
HD_PWD='C:/Users/sande/OneDrive/Documents/xilinx/VottingMachine/VottingMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VottingMachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VottingMachine.tcl
