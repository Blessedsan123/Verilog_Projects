...
HD_PWD='C:/Users/sande/OneDrive/Documents/xilinx/VottingMachine/VottingMachine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VottingMachine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VottingMachine.tcl -notrace
