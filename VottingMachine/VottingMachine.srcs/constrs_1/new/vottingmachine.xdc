...
set_property IOSTANDARD LVCMOS33 [get_ports bt4]
set_property IOSTANDARD LVCMOS33 [get_ports clock]
set_property IOSTANDARD LVCMOS33 [get_ports mode]
set_property IOSTANDARD LVCMOS33 [get_ports reset]
set_property PACKAGE_PIN T18 [get_ports bt1]
set_property PACKAGE_PIN R18 [get_ports bt2]
set_property PACKAGE_PIN R16 [get_ports bt3]
set_property PACKAGE_PIN N15 [get_ports bt4]
